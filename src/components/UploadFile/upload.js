...
export const isImageFile = (file, fileTypes) => {
  ...
  if (!isImage) {
    Message.error(i18n.t("cropper.formatError"))
    return false
  }
...
export const isMaxFileSize = (file, fileMaxSize = 1) => {
  ...
  if (!isMaxSize) {
    Message.error(i18n.t("cropper.fileSizeError") + fileMaxSize + 'MB!')
    return false
  }
  return true
}
...
// 获取base64图片大小，返回kb数字
// export const isMaxFileSize = (base64url, fileMaxSize = 2) => {
//   // 把头部去掉
...
//   }
//   const isMaxSize = size < fileMaxSize
